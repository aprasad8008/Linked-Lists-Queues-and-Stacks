...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        StringNode nodes = new StringNode(str.ch, null);
        StringNode copy = nodes;
        StringNode trav = str;
        
        while(trav.next != null)
        {
            StringNode nextPos = new StringNode(trav.next.ch, trav.next.next);
            copy.next = nextPos;
            copy = copy.next;
            trav = trav.next;
    ...
    public static void toUpperCase(StringNode str) {        
        ...
        System.out.print(Character.toUpperCase(str.ch));
        toUpperCase(str.next);
    }
    
    //prints the characters within the linked list at first in the correct order and then in reverse 
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println();
        System.out.println();
        System.out.print("Here it is mirrored: "); 
